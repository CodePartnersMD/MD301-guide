# Code Challenge 02: Object.keys, Object.values, and Object.entries
...
Copy [this set of challenges](keys-values-entries.test.js){:target="_blank"} into your `code-challenges` repository and check out a new branch. Work through each problem one at a time, verifying that your test passes before moving on to the next challenge.
