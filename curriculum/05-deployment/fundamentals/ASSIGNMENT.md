# Code Challenge 05: Split, Join, Slice, and Splice
...
Copy [this set of challenges](split-join-splice-slice.test.js){:target="_blank"} into your `code-challenges` repository and check out a new branch. Work through each problem one at a time, verifying that your test passes before moving on to the next challenge.
